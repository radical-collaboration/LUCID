...
def cellsam_pipeline(
    ...
    if use_wsi:
        ...
        mask, embedding, bounding_boxes = segment_cellular_image(inp, model=model, bbox_threshold=0.35, normalize=False, device=device)
    ...
    return mask, embedding, bounding_boxes
